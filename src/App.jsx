...
console.log(values)
  return (
    <div className='h-screen w-full bg-slate-200 flex justify-center items-center'>
      ...
      <div className='flex justify-center items-center flex-col gap-4 bg-gradient-to-br from-purple-600 to-pink-400 h-80 p-4 rounded-lg '>
        ...
        <button className='border-[1px] border-black p-2 my-4'><a href='' download={values}>
          DOWNLOAD</a></button>
      </div>
